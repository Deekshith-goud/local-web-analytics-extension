    ...
    <section className="settings-panel-layout tab-panel" aria-label="About the Extension">
      ...
      <div className="settings-card" style={{ padding: '32px' }}>
        ...
        <div className="settings-card-body" style={{ width: '100%' }}>
          ...
          <p style={{ fontSize: '15px', lineHeight: 1.6, color: 'var(--text)', marginBottom: '16px' }}>A community-driven, local-first browser extension designed to help you analyze your browsing habits, enforce productivity rules, and stay focused. Built openly with a strong focus on privacy, speed, and transparency.</p>
      ...
      <div className="settings-card">
        <div className="settings-card-icon purple" aria-hidden="true">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
        </div>
        <div className="settings-card-body">
          <h3>Open Source & Community</h3>
          <p style={{ marginBottom: '16px' }}>Initially created by <strong>Deekshith-goud</strong>, this project is open-source and welcomes community contributions. Feel free to open issues, suggest features, or submit pull requests to help us improve.</p>
